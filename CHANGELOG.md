...
- Replace bigint literals (`0n`, `1n`) with `BigInt()` calls for broader parser/transpiler compatibility
...
[1.2.1]: https://github.com/JiangJie/rsa-oaep-encryption/compare/v1.2.0...v1.2.1
